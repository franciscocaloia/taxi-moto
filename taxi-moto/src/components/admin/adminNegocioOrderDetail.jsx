...
import { CadeteOrderActions } from "../cadete/orders/cadeteOrderActions";
...
import { AdminNegocioOrderActions } from "./adminNegocioOrderActions";

export const AdminNegocioOrderDetail = ({ order }) => {
  let totalAmount = 0;
    ...
    <div className="w-full h-full p-6 lg:w-4/5 xl:w-2/3  mx-auto">
      <div className="card lg:h-full lg:card-side bg-base-100 shadow-xl">
        ...
        <div className="card-body lg:w-1/2 p-6">
          ...
          <AdminNegocioOrderActions order={order} />
        </div>
      </div>
    </div>
  );
